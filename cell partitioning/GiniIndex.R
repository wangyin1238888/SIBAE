...
gini.bi              = 1 # fitting, default is 0, for qPCR data, set as 1. 
...
Norm.Gini.cutoff     = 0.3 # fitting, NormGini, control how many Gini genes chosen, 1 means not used.
...
#load packages and functions1111111111111111
